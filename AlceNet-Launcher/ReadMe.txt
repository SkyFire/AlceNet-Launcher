========================================================================
   APLICACIÓN: AlceNet-Launcher Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación AlceNet-Launcher.  

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación AlceNet-Launcher.

AlceNet-Launcher.vcxproj
...
AlceNet-Launcher.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado AlceNet-Launcher.pch y un archivo de tipos 
